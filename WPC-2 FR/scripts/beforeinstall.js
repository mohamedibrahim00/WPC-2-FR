...
var resp = {
  ...
  nodes: [{
    ...
    fixedCloudlets: ${settings.st_fixedCloudlets:16},
...
if (${settings.galera:false}) {
  resp.nodes.push({
    ...
    fixedCloudlets: ${settings.db_fixedCloudlets:64},
...
if (${settings.ls-addon:false}) {
  resp.nodes.push({
    ...
    fixedCloudlets: ${settings.bl_fixedCloudlets:16},
    ...
    fixedCloudlets: ${settings.cp_fixedCloudlets:128},
